  ...
  const renderClassic = () => {
    return (
        <>
            <div
                class={[
                    'absolute top-13 left-0 h-full layout-border__right',
            ...
            <div style="transition: all var(--transition-time-02);width:100%">
                <ToolHeader
                    class={[
            ...
            <div
                ...
                <div class="flex items-center"   class="!h-[36px] " >
                ...
                <ElScrollbar
                    ...
                    class={[`${prefixCls}-content-scrollbar`, {'!h-[calc(100%-var(--top-tool-height)-var(--tags-view-height))]': fixedHeader.value}]}>
                    <AppView></AppView>
                </ElScrollbar>
            </div>
        </>
    ...
    const renderTopLeft = () => {
        return (
            <>
                ...
                <div
                    class="absolute left-0 top-[var(--logo-height)+1px] h-[calc(100%-1px-var(--logo-height))] w-full flex">
