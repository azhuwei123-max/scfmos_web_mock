  ...
  <ContentWrap>
    <div style="display: flex;justify-content: space-between;margin-bottom: 17px">
      ...
      <div>
        ...
        <el-button type="info" plain @click="handleJobLog()" v-hasPermi="['infra:job:query']" :header-cell-style="{background:'#F7F8FA'}">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          ...
          >
            <el-button tpye="" link><Icon icon="ep:d-arrow-right" /> 更多</el-button>
            <template #dropdown>
              <el-dropdown-menu>
