<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        <el-button @click="resetQuery" style="width: 74px;">
          重置
        </el-button>
        <el-button @click="handleQuery" tpye="" style="width: 74px;">
          查询
        </el-button>
      </el-form-item>
    </el-form>
  ...
  <ContentWrap>
    <div style="display: flex;justify-content: space-between;margin-bottom: 17px">
      ...
      <div>
        <el-button v-hasPermi="['infra:codegen:create']"  plain type="warning" @click="openImportTable()">
          <Icon icon="ep:upload" />
          导入
        </el-button>
      </div>
    </div>
    <el-table v-loading="loading" :data="list"   :header-cell-style="{background:'#F7F8FA'}">
      ...
      <el-table-column align="center" fixed="right" label="操作" width="200px">
        <template #default="scope">
          ...
          >
            <el-button tpye="" link> 更多</el-button>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item
                ...
                <el-dropdown-item
                  command="handleSyncDB"
                  v-if="checkPermi(['infra:codegen:update'])"
                >
                  同步
                </el-dropdown-item>
                <el-dropdown-item
                  command="handleGenTable"
