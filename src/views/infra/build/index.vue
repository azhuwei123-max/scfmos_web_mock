    ...
    <el-row>
      <el-col>
        <div class="float-right mb-2">
          <el-button size="small" tpye="" @click="showJson">生成 JSON</el-button>
          <el-button size="small" type="" @click="showOption">生成 Options</el-button>
          <el-button size="small" type="" @click="showTemplate">生成组件</el-button>
        </div>
      </el-col>
      <!-- 表单设计器 -->
      <el-col>
