<template>
  ...
  <ContentWrap title="">
    <div style="display: flex;justify-content: space-between;margin-bottom: 17px">
      <div style="font-size: 18px;font-weight: 700;"> 数据库文档</div>
      <div class="mb-10px">
        <el-button tpye="" plain @click="handleExport('HTML')">
          <Icon icon="ep:download" class="mr-5px"/> 导出 HTML
        </el-button>
        <el-button tpye="" plain @click="handleExport('Word')">
          <Icon icon="ep:download" class="mr-5px"/> 导出 Word
        </el-button>
        <el-button tpye="" plain @click="handleExport('Markdown')">
          <Icon icon="ep:download" class="mr-5px"/> 导出 Markdown
        </el-button>
      </div>
    </div>
    <el-divider />
