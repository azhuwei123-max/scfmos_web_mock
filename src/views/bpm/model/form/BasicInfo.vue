  ...
  <el-form ref="formRef" :model="modelData" :rules="rules" label-width="120px" class="mt-20px">
    ...
    <el-form-item label="谁可以发起" prop="startUserType" class="mb-20px">
      ...
      <div v-if="modelData.startUserType === 1" class="mt-2 flex flex-wrap gap-2">
        ...
        <el-button tpye="" link @click="openStartUserSelect">
      ...
      <div v-if="modelData.startUserType === 2" class="mt-2 flex flex-wrap gap-2">
        ...
        <el-button tpye="" link @click="openStartDeptSelect">
    ...
    <el-form-item label="流程管理员" prop="managerUserIds" class="mb-20px">
      <div class="flex flex-wrap gap-2">
        ...
        <el-button tpye="" link @click="openManagerUserSelect">
          <Icon icon="ep:plus" />选择人员
        </el-button>
      </div>
    </el-form-item>
    ...
    <el-form-item label="风险探测" prop="riskDetection" class="mb-20px">
      <el-radio-group v-model="modelData.riskDetection">
        <el-radio
          :value="true"
        >
          是
