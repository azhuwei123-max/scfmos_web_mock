      ...
      <el-scrollbar>
        ...
        <el-tabs v-model="activeTab">
          ...
          <el-tab-pane label="审批详情" name="form">
            ...
            element-loading-text="数据正在加载，请稍侯"
          ...
          <!-- 风险探测 -->
          <el-tab-pane label="签署意见" name="fxtc">
            <div 
            v-loading="processInstanceLoading"
            element-loading-text="数据正在加载，请稍侯"
            element-loading-spinner="el-icon-loading"
            ...
            >
              <el-scrollbar>
                <ApprovalOpinion  :process-instance="processInstance" :todo-task='todoTask' @setAppRoval="setAppRoval"  @submit="submit"/>
              </el-scrollbar>
            </div>
          </el-tab-pane>
        ...
        <div class="b-t-solid border-t-1px border-[var(--el-border-color)]">
          ...
          <ProcessInstanceOperationButton
            ...
            :approve-type-text="approveTypeText"
...
// import ApprovalOpinion from './approvalOpinion.vue'
const ProcessInstanceBpmnViewer = defineAsyncComponent(()=> import('./ProcessInstanceBpmnViewer.vue'))
const ProcessInstanceSimpleViewer = defineAsyncComponent(()=> import('./ProcessInstanceSimpleViewer.vue'))
const ProcessInstanceTaskList = defineAsyncComponent(()=> import('./ProcessInstanceTaskList.vue'))
const ProcessInstanceOperationButton = defineAsyncComponent(()=> import('./ProcessInstanceOperationButton.vue'))
const ProcessInstanceTimeline = defineAsyncComponent(()=> import('./ProcessInstanceTimeline.vue'))
const ApprovalOpinion = defineAsyncComponent(()=> import('./approvalOpinion.vue'))
...
const getApprovalDetail = async () => {
  ...
  try {
    ...
    console.log('todoTask',data.todoTask);
    ...
    //  activityNodes.value = (data.activityNodes || []).filter(node => node !== null && node!== undefined)
...
const approveTypeText = ref('')

const setAppRoval = (text) => {
  approveTypeText.value = text
}
</script>
