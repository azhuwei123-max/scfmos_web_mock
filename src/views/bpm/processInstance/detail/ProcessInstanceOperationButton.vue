<template>
  ...
  >
    ...
    >
      <template #reference>
        <el-button plain type="" @click="openPopover('approve')">
    ...
    >
      <template #reference>
        <el-button class="mr-20px" plain type="" @click="openPopover('reject')">
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handleCopy">-->
<!--              {{ getButtonDisplayName(OperationButtonType.COPY) }}-->
<!--            </el-button>-->
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handleTransfer()">-->
<!--              {{ getButtonDisplayName(OperationButtonType.TRANSFER) }}-->
<!--            </el-button>-->
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handleDelegate()">-->
<!--              {{ getButtonDisplayName(OperationButtonType.DELEGATE) }}-->
<!--            </el-button>-->
...
<!--    &lt;!&ndash; 【加签】按钮 当前任务审批人为A，向前加签选了一个C，则需要C先审批，然后再是A审批，向后加签B，A审批完，需要B再审批完，才算完成这个任务节点 &ndash;&gt;-->
<!--    <el-popover-->
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handlerAddSign('before')">-->
<!--              向前{{ getButtonDisplayName(OperationButtonType.ADD_SIGN) }}-->
<!--            </el-button>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handlerAddSign('after')">-->
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button :disabled="formLoading" tpye="" @click="handlerDeleteSign()">-->
<!--              减签-->
<!--            </el-button>-->
    ...
    >
      ...
      <div class="flex flex-col flex-1 pt-20px px-20px" v-loading="formLoading">
        ...
        >
          ...
          <el-form-item>
            <el-button :disabled="formLoading" tpye="" @click="handleReturn()">
              {{ getButtonDisplayName(OperationButtonType.RETURN) }}
            </el-button>
    ...
    >
      ...
      <div class="flex flex-col flex-1 pt-20px px-20px" v-loading="formLoading">
        ...
        >
          ...
          <el-form-item>
            <el-button :disabled="formLoading" tpye="" @click="handleCancel()">
              确认
            </el-button>
...
<RiskMonitorDialog
  ...
  @confirm="handleRiskMonitoConfirm"
  @cancel="handleRiskMonitoCancel"
/>
...
watch(
  ...
  () => {
    if (props.processDefinition) {
      simpleModel.value = JSON.parse(props.processDefinition.simpleModel)
      console.log('wewqeqw',simpleModel.value);
...
const handleRiskMonitoConfirm = (ispass) => {
  if(ispass) {
    isCheckFlag.value = '通过检测'
  } else {
    isCheckFlag.value = "未通过检测"
  }
}
...
const openPopover = async (type: string) => {
  ...
  if (type === 'approve') {
    ...
    // if(isCheckFlag.value == '通过检测') {
   
    //    initNextAssigneesFormField()
    // }
    

    // if(isCheckFlag.value == '未通过检测') {
    //    message.warning('未通过检测!!')
    // }
    
     initNextAssigneesFormField()
 
  // const riskDetection = !!props.processDefinition?.riskDetection && props.processDefinition.approvalPath && isCheckFlag.value=='未进行检测' //是否需要做风险探测
    ...
    // currentProcessInstance.value = props.processInstance
  ...
  if (data && data.length > 0) {
    ...
    data.forEach((node: any) => {
      if (
        ...
        console.log('meiyou asdasdasd', props.approveTypeText)
    ...
    if (pass) {
      ...
      if (Object.keys(formCreateApi)?.length > 0) {
        ...
        //  data.variables = approveForm.value.value
         data.variables = props.approveTypeText
      }

      console.log('data',data,props.approveTypeText);
