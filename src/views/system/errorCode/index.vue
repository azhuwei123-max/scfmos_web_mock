<template>
  ...
  <ContentWrap>
    ...
    >
      <el-form-item label="错误码类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择错误码类型" clearable style="width: 170px">
          <el-option
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" :header-cell-style="{background:'#F7F8FA'}">
      ...
      />
      <el-table-column label="操作" align="center" class-name="small-paddingfixed-width" :width="140">
        <template #default="scope">
          <el-button
            link
            tpye=""
