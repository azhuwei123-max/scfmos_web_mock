  ...
  <ContentWrap>
    <div style="display: flex;justify-content: space-between;margin-bottom: 17px">
      ...
      <div>
        ...
        <el-button plain type="" @click="toggleExpandAll">
    ...
    <el-table
      ...
      <el-table-column align="center" label="图标" prop="icon" >
        <template #default="scope">
          <svg aria-hidden="true" class="svg-icon" style="height:22px;width:22px">
            <use v-if="scope.row.icon" :xlink:href="'#icon-'+`${scope.row.icon == null?'':scope.row.icon.substring(3)}`" fill="#252525" ></use>
          </svg>
        </template>
      </el-table-column>
