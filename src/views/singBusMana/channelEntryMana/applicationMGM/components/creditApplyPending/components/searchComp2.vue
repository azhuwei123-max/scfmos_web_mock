<template>
  ...
  >
    ...
    <el-form-item label="授信申请编号" prop="creditApplyNo">
      <el-input
        v-model="queryParams.creditApplyNo"
        class="!w-240px"
        clearable
        placeholder="请输入授信申请编号"
      />
    </el-form-item>
    ...
    <el-form-item label="业务合同编号" prop="bcNo">
      <el-input
        v-model="queryParams.bcNo"
        class="!w-240px"
        clearable
        placeholder="请输入业务合同编号"
      />
    </el-form-item>
    <el-form-item>
