...
export const getDetailInfo = (params) => {
  return request.get({ url: '/system/business-contract/getDetailInfo', params })
}
...
// 获取客户详情表单字段配置
export const getCreditTempFiled = (params) => {
  return request.get({ url: '/system//business-contract/getCreditTempFiled', params })
}
...
// 判断供应链字段是否只读
export const gylFlagOnlyRead = (params) => {
  return request.get({ url: '/system/business-contract/gylFlagOnlyRead', params })
}
