<template>
  <ContentWrap v-loading="pageLoading" :body-style="{ padding: '10px 15px 0px' }">
    <!-- 搜索工作栏 -->
  ...
  <ContentWrap :body-style="{ padding: '0px 15px' }">
    ...
    <selectTable2Pop ref="selectTable2Ref" :params="{ applyType: 'ApproveCreditContract',creditSourceFlag: '01' }" @confirm="getList" />
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, '项目额度合同审批.xls')
