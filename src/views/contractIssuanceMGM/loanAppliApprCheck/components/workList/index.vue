<template>
  <ContentWrap>
    <!-- 搜索工作栏 -->
    <div class="flex items-center w-[110px]" @click="isExpand = !isExpand">
  ...
  <!-- 列表 -->
    <div class="mt-1.5" style="display: flex; justify-content: space-between; margin-bottom: 17px">
  ...
  <Dialog v-model="backMsgConfirmShow" title="提示">
   ...
   <CreditFlowApproval
    ...
    />
  <selectTable2Pop ref="selectTable2Ref" :params="{ applyType: 'ApprovePutOutApply',creditSourceFlag: '02' }" @confirm="getList" />
