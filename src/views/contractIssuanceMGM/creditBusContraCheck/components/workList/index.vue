<template>
  <ContentWrap v-loading="pageLoading">
    ...
    <MiniPageSelectDialog
      ...
      :extra-params="extraParams3"
    />

    <selectTable2Pop ref="selectTable2Ref" :params="{ applyType: 'ApproveBusinessContract',creditSourceFlag: '01' }" @confirm="getList" />
...
const {
  ...
  tableCurrentChange,
  fetchCback
} = useTableList(Api.ywContractList, { ...props.params,creditSourceFlag:'01' }, false)
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, '项目业务合同审批.xls')
