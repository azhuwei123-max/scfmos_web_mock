    ...
    <el-row>
      <div class="select-item" v-if="reply.articles && reply.articles.length > 0">
        ...
        <el-col class="ope-row">
          <el-button type="" circle @click="onDelete">
            <Icon icon="ep:delete" />
          </el-button>
        </el-col>
      </div>
      ...
      <el-col :span="24" v-if="!reply.content">
        <el-row style="text-align: center" align="middle">
          <el-col :span="24">
            <el-button type="" @click="showDialog = true">
      ...
      <el-dialog title="选择图文" v-model="showDialog" width="90%" append-to-body destroy-on-close :close-on-click-modal="false">
        <WxMaterialSelect
          type="news"
