<template>
  <el-dialog title="新建视频" v-model="showDialog" width="600px" :close-on-click-modal="false">
    <el-upload
      :action="UPLOAD_URL"
      :headers="HEADERS"
      multiple
    ...
    >
      <template #trigger>
        <el-button tpye="" plain>选择视频</el-button>
      </template>
      <template #tip>
    ...
    <template #footer>
      <el-button tpye="" @click="submitVideo">提 交</el-button>
