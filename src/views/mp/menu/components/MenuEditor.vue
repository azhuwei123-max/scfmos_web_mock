  ...
  <div>
    <div class="configure_page">
      <div class="delete_btn">
        <el-button type="" @click="emit('delete')">
          <Icon icon="ep:delete" />
          删除当前菜单
        </el-button>
      </div>
          ...
          <el-row>
            <div class="select-item" v-if="menu && menu.replyArticles">
              ...
              <el-row class="ope-row" justify="center" align="middle">
                <el-button type="" circle @click="deleteMaterial">
                  <icon icon="ep:delete" />
                </el-button>
              </el-row>
            </div>
            <div v-else>
              <el-row justify="center">
                <el-col :span="24" style="text-align: center">
                  <el-button type="" @click="showNewsDialog = true">
                    素材库选择
            ...
            <el-dialog title="选择图文" v-model="showNewsDialog" width="80%" destroy-on-close :close-on-click-modal="false">
              <WxMaterialSelect
                type="news"
