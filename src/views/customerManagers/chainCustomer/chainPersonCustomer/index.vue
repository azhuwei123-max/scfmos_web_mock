...
import { personalApi } from '@/api/customerInfoMGM/lskh'
...
defineOptions({ name: 'chainPersonCustomer' })
...
const handleRowDetail = (row: any) => {
  // 跳转到详情页面
  router.push({
    path:`chainPersonCusDetail/${row.customerId}`,
    query: {
...
const handleDelete = async () => {
  ...
  try {
    ...
    // await CustomerPersonalApi.delete(ids)
