...
export const tableColumns: TableColumn[] = [
  ...
  { label: '证件号', field: 'certId1', minWidth: 180 },
  { label: '是否我行定义小微', field: 'isSmallScope', minWidth: 150 },
  { label: '核心客户号', field: 'mfCustomerID', minWidth: 120 },
  { label: '主办客户经理', field: 'userName', minWidth: 120 },
  { label: '主办机构', field: 'orgName', minWidth: 120 },
  { label: '客户主办权', field: 'belongAttribute', minWidth: 120 },
  { label: '信息维护权', field: 'belongAttribute2', minWidth: 120 },
  { label: '信息查看权', field: 'belongAttribute1', minWidth: 120 },
  { label: '业务申办权', field: 'belongAttribute3', minWidth: 120 },
  { label: '暂存标识', field: 'tempSaveFlag', minWidth: 120 }
]
