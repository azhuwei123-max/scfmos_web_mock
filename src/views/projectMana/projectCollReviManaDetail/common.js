...
export const tempList = [
  ...
  new DynamicForm('BasicPart', '申请分行', 'branchname', 'input', base3('1', '1', '1')),
  new DynamicForm('BasicPart', '申请分行业务团队', 'inputorgid', 'input', base3('1', '1', '1')),

  // 项目方案内容
  new DynamicForm('ProjectPart', '项目额度', 'businesssum', 'number', {
    ...base3('1'),
    colmaxnum: '9999999999',
    colunit: '万元'
  }),
  new DynamicForm('ProjectPart', '项目敞口', 'exposuresum', 'number', {
    ...base3('1'),
    colmaxnum: '9999999999',
    colunit: '万元'
  }),
  ...
  new DynamicForm('AssistPart', '链属企业推荐户数', 'recommendnum', 'input', { ...base3('1'), collimit: '4' }),
  new DynamicForm('AssistPart', '调查联系户数', 'searchnum', 'input', { ...base3('1'), collimit: '4' }),
  new DynamicForm('AssistPart', '链属企业名称', 'spcsentname', 'textarea', { ...base3('1'), collimit: '500' }),
