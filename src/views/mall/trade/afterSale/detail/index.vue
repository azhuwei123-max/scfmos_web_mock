  ...
  <ContentWrap>
    ...
    <el-descriptions :column="1" title="退款状态">
      ...
      <el-descriptions-item label-class-name="no-colon">
        <el-button v-if="formData.status === 10" tpye="" @click="agree">同意售后</el-button>
        <el-button v-if="formData.status === 10" tpye="" @click="disagree">
          拒绝售后
        </el-button>
        <el-button v-if="formData.status === 30" tpye="" @click="receive">
          确认收货
        </el-button>
        <el-button v-if="formData.status === 30" tpye="" @click="refuse">拒绝收货</el-button>
        <el-button v-if="formData.status === 40" tpye="" @click="refund">确认退款</el-button>
      </el-descriptions-item>
      <el-descriptions-item>
