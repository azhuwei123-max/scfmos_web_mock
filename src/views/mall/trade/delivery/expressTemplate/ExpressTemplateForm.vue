<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1300px">
    ...
    >
        ...
        <el-table border style="width: 100%" :data="formData.charges">
          ...
          <el-table-column label="操作" align="center">
            <template #default="scope">
              <el-button link type="" @click="deleteChargeArea(scope.$index)">
                删除
              </el-button>
            </template>
          </el-table-column>
      ...
      <el-form-item>
        <el-button tpye="" plain @click="addChargeArea()">
      ...
      <el-form-item label="包邮区域" prop="frees">
        <el-table border style="width: 100%" :data="formData.frees">
          ...
          <el-table-column label="操作" align="center">
            <template #default="scope">
              <el-button link type="" @click="deleteFreeArea(scope.$index)"> 删除 </el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
      <el-form-item>
        <el-button tpye="" plain @click="addFreeArea()">
          <Icon icon="ep:plus" class="mr-5px" /> 添加区域
        </el-button>
      </el-form-item>
