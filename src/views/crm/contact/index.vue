  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="['crm:contact:create']" tpye="" @click="openForm('create')">
    ...
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      <el-table-column align="center" fixed="left" label="联系人姓名" prop="name" width="160">
        <template #default="scope">
          <el-link :underline="false" tpye="" @click="openDetail(scope.row.id)">
            {{ scope.row.name }}
          </el-link>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="直属上级" prop="parentName" width="160">
        <template #default="scope">
          <el-link :underline="false" tpye="" @click="openDetail(scope.row.parentId)">
