<template>
  <CustomerDetailsHeader :customer="customer" :loading="loading">
    ...
    <el-button v-if="permissionListRef?.validateOwnerUser" tpye="" @click="transfer">
      转移
    </el-button>
    ...
    <el-button v-if="!customer.ownerUserId" tpye="" @click="handleReceive"> 领取</el-button>
    <el-button v-if="!customer.ownerUserId" tpye="" @click="handleDistributeForm">
      分配
    </el-button>
    <el-button
