<template>
   <ContentWrap>
    ...
    <div class="mb-15px flex flex-wrap">
      <el-button @click="handleCreate" v-if="(route.query.phaseNo=='0010' || route.query.phaseNo=='1030' || route.query.phaseNo=='3000') && route.query.type != 'Y'">
      ...
      <el-button type="" @click="handleDelete" v-if="(route.query.phaseNo=='0010'|| route.query.phaseNo=='1030' || route.query.phaseNo=='3000') && route.query.type != 'Y'">
        删除
      </el-button>
