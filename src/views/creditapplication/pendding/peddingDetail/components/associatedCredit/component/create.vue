      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="额度金额" prop="amount">
            <el-input v-model="formData.amount"  class="w-100%" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
const searchFields = [
  { label: '合同流水号', prop: 'SERIALNO' ,queryProp:'SerialNo'},
  { label: '客户名称', prop: 'customerName',queryProp:'CustomerName' }
]
...
const columns = [
{prop:'SERIALNO',label:"合同流水号",minWidth:120},
