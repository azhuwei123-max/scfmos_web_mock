...
const open = async (serialNo,baCreditNo,phaseNo,type) => {
  ...
  initAllotDetail(serialNo,baCreditNo)
}
...
const initAllotDetail = (serialNo,baCreditNo) => {
  formLoading.value = true
  Api.businessAllotDetail({ serialNo,baCreditNo }).then((res) => {
