<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="是否我行定义小微" label-width="130px" prop="status">
        <el-select
    ...
    >
      ...
      <el-table-column align="center" label="客户名称" fixed width="250" prop="customerName" />
...
const goDetail = () => {
  ...
  router.push({
    path: 'companyCustomerMGM/customerMGM/customerDetail',
    query: {
      customerID: currentRow.value.customerID,
