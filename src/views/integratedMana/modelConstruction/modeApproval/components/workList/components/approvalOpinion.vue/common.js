...
export const tempList = [
  ...
  new DynamicForm('BasicPart', '申请业务团队', 'inputorgid', 'input', base3('1')),
  ...
  new DynamicForm('AssistPart', '如否，请简述原因', 'isnoreason', 'textarea', {
    collimit: '5000'
  }),
  new DynamicForm('AssistPart', '链属企业推荐户数', 'recommendnum', 'number', base3('1')),
  new DynamicForm('AssistPart', '调查联系户数', 'searchnum', 'number', base3('1')),
