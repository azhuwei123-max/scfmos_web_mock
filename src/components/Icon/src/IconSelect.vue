...
<template>
  <div class="selector">
    <ElInput v-model="inputValue" clearable @click="visible = !visible" @clear="onClear">
      <template #append>
        <ElPopover
          :popper-options="{
            placement: 'auto'
        ...
        >
          <template #reference>
            ...
            >
              <Icon
                v-if="icon"
                :icon="currentActiveType + icon"
                :size="20"
                class="text-[var(--left-menu-text-color,#1f2937)]"
              />
            </div>
          </template>
<!--          搜索条件-->
            ...
            >
              ...
              <ElScrollbar height="220px">
                <ul class="ml-2 flex flex-wrap px-2">
                  ...
                  >
                    <Icon :icon="currentActiveType + item" :size="18" />
                  </li>
                </ul>
              </ElScrollbar>
            </ElTabPane>
