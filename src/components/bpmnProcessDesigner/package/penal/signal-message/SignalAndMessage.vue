<template>
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      ...
      <XButton tpye="" title="创建新消息" preIcon="ep:plus" @click="openModel('message')" />
    </div>
    ...
    >
      ...
      <XButton tpye="" title="创建新信号" preIcon="ep:plus" @click="openModel('signal')" />
    </div>
    ...
    >
      ...
      <template #footer>
        <el-button tpye="" @click="addNewObject">保 存</el-button>
