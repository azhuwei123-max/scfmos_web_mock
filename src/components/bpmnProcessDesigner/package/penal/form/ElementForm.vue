<template>
  <div class="panel-tab__content">
      ...
      <el-table :data="fieldList" max-height="240" fit border>
        ...
        <el-table-column label="操作" width="90px">
          <template #default="scope">
            <el-button tpye="" link @click="openFieldForm(scope, scope.$index)"
              >编辑</el-button
            >
    ...
    <div class="element-drawer__button">
      <XButton tpye="" proIcon="ep:plus" title="添加字段" @click="openFieldForm(null, -1)" />
    </div>
    ...
    >
      ...
      <template v-if="formFieldForm.type === 'enum'">
        ...
        <p class="listener-filed__title" key="enum-title">
          ...
          <el-button tpye="" @click="openFieldOptionForm(null, -1, 'enum')"
            >添加枚举值</el-button
          >
        </p>
      ...
      <p class="listener-filed__title" key="validation-title">
        ...
        <el-button tpye="" @click="openFieldOptionForm(null, -1, 'constraint')"
          >添加约束</el-button
        >
      </p>
      ...
      <p class="listener-filed__title" key="property-title">
        ...
        <el-button tpye="" @click="openFieldOptionForm(null, -1, 'property')"
          >添加属性</el-button
        >
      </p>
      ...
      <div class="element-drawer__button">
        ...
        <el-button tpye="" @click="saveField">保 存</el-button>
      </div>
    </el-drawer>
    ...
    >
      ...
      <template #footer>
        <el-button tpye="" @click="saveFieldOption">确 定</el-button>
