  ...
  <div class="panel-tab__content">
    ...
    >
      ...
      <p class="listener-filed__title">
        ...
        <el-button size="small" tpye="" @click="openListenerFieldForm(null)"
          >添加字段</el-button
        >
      </p>
      <el-table
      ...
      <div class="element-drawer__button">
        ...
        <el-button size="small" tpye="" @click="saveListenerConfig">保 存</el-button>
      </div>
    </el-drawer>
    ...
    >
      ...
      <template #footer>
        <el-button size="small" tpye="" @click="saveListenerFiled">确 定</el-button>
